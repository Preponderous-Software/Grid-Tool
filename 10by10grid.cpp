...
const int SCREEN_WIDTH = 750; // must be multiples of 10
const int SCREEN_HEIGHT = 750; // must be multiples of 10

const int GRID_SLOT_WIDTH = SCREEN_WIDTH/10;
const int GRID_SLOT_HEIGHT = SCREEN_HEIGHT/10;
